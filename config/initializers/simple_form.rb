...
SimpleForm.setup do |config|
  ...
  config.wrappers :label_wrapped, :tag => 'div', :class => "control-group", :error_class => 'error' do |b|
    b.use :placeholder
    b.use :tag => 'div', :class => 'controls wrapped' do |ba|
      ba.use :label_nested_input
#      ba.use :input
#      ba.use :tag => 'span', :class => 'label-wrapped' do |label|
...
#    b.use :tag => 'div', :class => 'controls' do |input|
#      input.use :label, :class => 'control-label'

#  config.wrappers :label_wrapped, :class => "controls", :error_class => :error do |b|
#    b.use :placeholder
